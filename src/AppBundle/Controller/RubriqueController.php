...
class RubriqueController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $rubriques = $em->getRepository('AppBundle:Rubrique')->findListASC();
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('backend_rubrique_show', array('id' => $rubrique->getId()));
        }
     ...
     *
     * @Route("/{id}/edit", name="backend_rubrique_edit")
     * @Method({"GET", "POST"})
     */
